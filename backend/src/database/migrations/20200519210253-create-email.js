/*
  yarn|npm sequelize db:migrate --name 20200519210253-create-email --env development // create table
  yarn|npm sequelize db:migrate --env development // create all tables
  yarn|npm sequelize db:migrate:undo --name 20200519210253-create-email --env development // drop table
  yarn|npm sequelize db:migrate:undo:all --env development  // drop all tables

  yarn|npm sequelize db:migrate --name 20200519210253-create-email --env test // create table
  yarn|npm sequelize db:migrate --env test // create all tables
  yarn|npm sequelize db:migrate:undo --name 20200519210253-create-email --env test // drop table
